...
namespace ProjectTracker.Library.Admin
{
  ...
  public class RoleEdit : BusinessBase<RoleEdit>
  {
    ...
    protected override void AddBusinessRules()
    {
      ...
      BusinessRules.AddRule(new Csla.Rules.CommonRules.IsInRole(Csla.Rules.AuthorizationActions.WriteProperty, IdProperty, Roles.Administrator));
      BusinessRules.AddRule(new Csla.Rules.CommonRules.IsInRole(Csla.Rules.AuthorizationActions.WriteProperty, NameProperty, Roles.Administrator));
    }
    ...
    [FetchChild]
    private void Fetch(Roledto data)
    {
