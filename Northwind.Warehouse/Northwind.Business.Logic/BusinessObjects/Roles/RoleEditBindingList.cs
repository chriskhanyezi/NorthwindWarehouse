    ...
    public class RoleEditBindingList : BusinessBindingListBase<RoleEditBindingList, RoleEdit>
    {
      ...
      public static void AddObjectAuthorizationRules()
      {
        Csla.Rules.BusinessRules.AddRule(typeof(RoleEditBindingList),
          new Csla.Rules.CommonRules.IsInRole(Csla.Rules.AuthorizationActions.CreateObject, Roles.Administrator));
        Csla.Rules.BusinessRules.AddRule(typeof(RoleEditBindingList),
          new Csla.Rules.CommonRules.IsInRole(Csla.Rules.AuthorizationActions.EditObject, Roles.Administrator));
        Csla.Rules.BusinessRules.AddRule(typeof(RoleEditBindingList),
          new Csla.Rules.CommonRules.IsInRole(Csla.Rules.AuthorizationActions.DeleteObject, Roles.Administrator));
      }
