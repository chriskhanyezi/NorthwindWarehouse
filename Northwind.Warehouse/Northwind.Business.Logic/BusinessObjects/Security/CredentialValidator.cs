...
namespace Northwind.Business.Logic.Security
{
    ...
    public class CredentialValidator : ReadOnlyBase<CredentialValidator>
    {
        ...
        public static readonly PropertyInfo<bool> VerifiedProperty = RegisterProperty<bool>(nameof(Verified));
        public bool Verified
        {
            get => GetProperty(VerifiedProperty);
            private set => LoadProperty(VerifiedProperty, value);
        }
